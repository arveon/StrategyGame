...
load_window::load_window()
{
	...
	SDL_Texture* texture = sdlframework::sdl_manager::create_texture(200, 200, {150,150,150});
	SDL_Texture* selected_bg = sdlframework::sdl_manager::create_texture(290, 50, { 200, 150, 110 });
	...
	saves_list = item_list(fontpath, { 50, 50, 170 }, texture, { 10, 10, 200, 200 }, selected_bg, items, 5);
}
